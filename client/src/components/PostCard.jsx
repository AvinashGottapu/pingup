  ...
  return (
    <div className="bg-white rounded-xl shadow p-4 space-y-4 w-full max-w-2xl">
      ...
      {/* Content */}
      {
        ...
        // const text = "<b>Hello</b> World";  =>  dangerouslySetInnerHTML => Hello is Bold
        // If we renders like this <p>{text}</p>; OP => <b>Hello</b> World.
      }
      {/* Images */}
      ...
      <div className="flex items-center gap-4 text-gray-600 text-sm pt-2 border-t border-gray-300">
        {/* border-t => 1px border  border-t-n => n-px border expect-1  */}
