...
const StoriesBar = () => { 
  ...
  return (
    <div className='w-screen sm: w-[100vw-240px] lg:max-w-2xl no-scrollbar overflow-x-auto px-4'>
        ...
        <div className='flex gap-4 pb-5'> 
            ...
            { 
              stories.map((story,index) => (
                ...
                hover:shadow-lg transtion-all duration-200 bg-gradient-to-b from indigo from-indigo-500 to-purple-600 hover:from-indigo-700  hover:to-purple active:scale-95`}> 
