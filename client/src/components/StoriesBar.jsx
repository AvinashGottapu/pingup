  ...
  return (
    <div className='w-full max-w-2xl no-scrollbar overflow-x-auto px-2 sm:px-4'>
      ...
      <div className='flex gap-4 pb-5'>
        {/* Add story-Cart */}
        <div onClick={() => setShowModal(true)} className='rounded-lg shadow-sm min-w-[120px] max-w-[140px] max-h-40 aspect-[3/4] cursor-pointer hover:shadow:lg transition-all duration-200 border-2 border-dashed border-indigo-300 bg-gradient-to-b from-indigo-50 to-white dark:from-slate-800 dark:to-slate-900 dark:border-indigo-700'>
          <div className='h-full flex flex-col items-center justify-center p-4'>
            <div className='size-10 bg-indigo-500 rounded-full flex items-center justify-center mb-3'>
              <Plus className='w-5 h-5 text-white' />
            </div>
            <p className='text-sm font-medium text-slate-700 dark:text-slate-300 text-center'> Create Story </p>
          </div>
