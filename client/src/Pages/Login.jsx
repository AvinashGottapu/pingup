       ...
       <div className='flex-1 flex flex-col items-start justify-between p-6 p-10'> 
        ...
        <div>
          ...
          <div>
            ...
            <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent'> More than just friend just connect </h1> 
