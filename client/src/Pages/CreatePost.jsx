          ...
          <p className='text-slate-600'> Share your thoughts with the world </p>
            ...
            <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'> 
                  ...
                  <div className='flex items-center gap-3'> 
                   ...
                   {/* Text-area */} 
                   <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' placeholder="What's Happpening" onChange={(e) => setContent(e.target.value)} value={content}/> 
