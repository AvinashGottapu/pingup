    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='max-w-xl bg-white dark:bg-slate-900 p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          {/* Text-area */}
          <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400 dark:placeholder-gray-500 bg-transparent dark:text-white' placeholder="What's Happpening" onChange={(e) => setContent(e.target.value)} value={content} />
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300 dark:border-slate-700'>
            ...
            <button disabled={loading} onClick={handleSubmit} className='text-sm bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white font-medium px-8 py-2 rounded-md cursor-pointer'>
              Publish Post
            </button>
          </div>
